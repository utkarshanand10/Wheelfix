...
const BookingModal: React.FC<BookingModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Determine effective price (prefer discountedPrice when present and lower)
      ...
      const bookingPayload = {
        ...
        amount: Math.round((effectivePrice ?? 0) * 100), // Convert to paise for consistency
        // Service details
        ...
        {bookingSuccess ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              Thank you for choosing our service. Our team will contact you soon
              to confirm your booking and schedule.
            </p>
            <Button
              onClick={handleClose}
